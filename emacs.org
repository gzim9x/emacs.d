...
(use-package doom-modeline
  ...
  :custom-face
  (mode-line ((t (:height 0.9 :background "gray8"))))
  (mode-line-inactive ((t (:height 0.9 :background "gray12")))))
#+end_src
...
(use-package treemacs
  ...
  :custom-face
  (treemacs-file-face ((t (:inherit dafault
                           :font "Iosevka"
                           :height 120))))
...
#+RESULTS: treemacs
: #s(hash-table size 65 test eql rehash-size 1.5 rehash-threshold 0.8125 data (:use-package (24890 24571 720569 0) :init (24890 24571 720530 0) :init-secs (0 0 275 0) :use-package-secs (0 0 399 0) :config (24890 24571 720505 0) :config-secs (0 0 245 0)))
...
(use-package smartparens
  ...
  ;; bindings keys scheme https://ebzzry.com/en/emacs-pairs/
  :bind (:map smartparens-mode-map
         ...
         ;; Wrapping
         ("C-c (" . (lambda (_) (interactive "P") (sp-wrap-with-pair "(")))
         ("C-c [" . (lambda (_) (interactive "P") (sp-wrap-with-pair "[")))
         ("C-c {" . (lambda (_) (interactive "P") (sp-wrap-with-pair "{")))
...
https://www.gnu.org/software/emacs/manual/html_mono/newsticker.html

Newsticker provides a Feed Reader for Emacs. It retrieves headlines from a
list of news sites, processes them, and provides frontends for reading and
managing them. (Standard headline formats are RSS and Atom which makes
Newsticker an “RSS Reader”, “Atom Reader” or “Feed Aggregator”.)
...
(use-package newsticker
  ...
  :custom-face
  (newsticker-treeview-face ((t (:weight normal))))
  (newsticker-treeview-new-face ((t (:inherit 'newsticker-treeview-face
                                     ;; :weight normal
                                     :foreground "plum2"))))
  (newsticker-treeview-old-face ((t (:inherit 'newsticker-treeview-face
                                     ;; :weight normal
                                     :foreground "RosyBrown3"))))
  ;; newsticker-treeview-new-face

  :custom
  (newsticker-url-list my-newsticker-url-list))
#+end_src
...
https://github.com/nlamirault/all-the-icons-gnus
...
(use-package gnus
  ...
  :after (all-the-icons-gnus gnus-select-account)
